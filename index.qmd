...
if((x%%3 == 0) & (x%%5 ==0)){x <- "fizzbuzz"} else if(x%%5 == 0){x<-"buzz"} else if(x%%3 == 0){x<-"fizz"} else{x <- x}
print(x)
```
...
for (num in xx){if((xx[num]%%3 == 0) & (xx[num]%%5 ==0)){yy[num] <- "fizzbuzz"} else if(xx[num]%%5 == 0){yy[num]<-"buzz"} else if(xx[num]%%3 == 0){yy[num]<-"fizz"} else{yy[num] <- xx[num]}
}
